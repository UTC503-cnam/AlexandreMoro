...
const assertionTypes = new Set(Object.keys(assertions_1.Assertion).map(key => assertions_1.Assertion[key]));
/**
 * Extract all assertions.
 *
 * @param program - TypeScript program.
 */
exports.extractAssertions = (program) => {
 ...
 */
exports.parseErrorAssertionToLocation = (assertions) => {
